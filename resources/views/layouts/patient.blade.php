...
<body>
    <div class="sidebar">
        <div class="brand">
            <h3><i class="fas fa-user-injured"></i> Patient Portal</h3>
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link {{ request()->routeIs('patient.appointments.create') ? 'active' : '' }}" href="{{ route('patient.appointments.create') }}">
                <i class="fas fa-calendar-plus"></i> Book Appointment
            </a>
            <a class="nav-link {{ request()->routeIs('patient.medical-records.*') ? 'active' : '' }}" href="{{ route('patient.medical-records.index') }}">
                <i class="fas fa-notes-medical"></i> Medical Records
            </a>
            <a class="nav-link {{ request()->routeIs('patient.billing.*') ? 'active' : '' }}" href="{{ route('patient.billing.index') }}">
                <i class="fas fa-receipt"></i> My Bills
            </a>
            <a class="nav-link {{ request()->routeIs('patient.account.*') ? 'active' : '' }}" href="{{ route('patient.account.profile') }}">
        ...
        <div class="topbar d-flex justify-content-between align-items-center">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ route('patient.account.profile') }}"><i class="fas fa-user"></i> My Profile</a></li>
