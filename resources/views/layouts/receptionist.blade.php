...
<head>
    ...
    <title>Receptionist Panel - @yield('title')</title>
    ...
    <style>
        ...
        .sidebar {
            ...
            height: 100vh;
            width: 250px;
            background: linear-gradient(135deg, #0f5e5e 0%, #0a4a4a 100%);
            color: white;
            transition: all 0.3s;
            z-index: 1000;
        }
...
<body>
    <div class="sidebar">
        <div class="brand">
            <h3><i class="fas fa-user-tie"></i> Reception Desk</h3>
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link {{ request()->routeIs('receptionist.patients.*') ? 'active' : '' }}" href="{{ route('receptionist.patients.register') }}">
            ...
            <a class="nav-link {{ request()->routeIs('receptionist.billing.*') ? 'active' : '' }}" href="{{ route('receptionist.billing.index') }}">
                <i class="fas fa-receipt"></i> Billing
            </a>
            <a class="nav-link {{ request()->routeIs('receptionist.records.*') ? 'active' : '' }}" href="{{ route('receptionist.records.patients') }}">
